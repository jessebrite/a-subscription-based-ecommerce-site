...
if (isset($_GET['id']) && filter_var($_GET['id'], FILTER_VALIDATE_INT, array('min_range' => 1))) {
	...
	if (isset($_SESSION['user_not_expired'])) {
		...
		$sql = 'SELECT user_id FROM favorite_pages WHERE user_id = ' . $_SESSION['user_id'] . ' AND page_id = ' . $_GET['id'];
		...
		$sql = "INSERT INTO history (user_id, type, page_id) VALUES ({$_SESSION['user_id']}, 'page', {$_GET['id']})";
		$result = mysqli_query($dbc, $sql);
